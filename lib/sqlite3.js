...
console.log("bind_path is: ", binding_path)
var tryToSplitPos = binding_path.search("binding");
var subBindingStr = binding_path.substr(tryToSplitPos+7);

console.log("process in development or production: ", process.env.NODE_ENV);

var stringAsSplitter = ''

if(process.env.NODE_ENV === 'development'){
    stringAsSplitter = "node_modules"
}else{
    stringAsSplitter = "resources"
}

var tryToSplitPos = binding_path.search(stringAsSplitter);
var subFolderStr = binding_path.substr(0, tryToSplitPos-1);
console.log("this is subBindingStr" , subBindingStr);
console.log("dir name is: ", __dirname);

console.log("this is subFolderStr" , subFolderStr);
binding_path = subFolderStr + subBindingStr;
